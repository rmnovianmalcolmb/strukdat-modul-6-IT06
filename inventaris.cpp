...
public:
    ...
    int getKodeBarang(size_t index) const { return kodeBarang[index]; }
    string getNamaBarang(size_t index) const { return namaBarang[index]; }
    int getJumlahBarang(size_t index) const { return jumlahBarang[index]; }
    size_t getProductCount() const { return kodeBarang.size(); }
};
...
public:
    ...
    int getKodePinjam(size_t index) const { return kodePinjam[index]; }
    string getNamaPinjam(size_t index) const { return namaPinjam[index]; }
    string getBarangPinjam(size_t index) const { return barangPinjam[index]; }
    int getJumlahPinjam(size_t index) const { return jumlahPinjam[index]; }
    string getLamaPinjam(size_t index) const { return lamaPinjam[index]; }
    string getWaktuPinjam(size_t index) const { return waktuPinjam[index]; }
    string getStatus(size_t index) const { return status[index]; }
    string getWaktuKembali(size_t index) const { return waktuKembali[index]; }
    size_t getLoanCount() const { return kodePinjam.size(); }
};
